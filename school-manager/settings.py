...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_ROOT_PATH, 'db'), # Or path to database file if using sqlite3.
...
SECRET_KEY = 'fm_=i*y@mv&qldvpdaejjqd-6cb2-a2^woui#1(ekx$10$qtbq'
...
ROOT_URLCONF = 'django-school-manager.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'django-school-manager.wsgi.application'
...
FULLCALENDAR_MEDIA_URL = MEDIA_URL+'fullcalendar/'
FULLCALENDAR = {
    ...
    'jquery_url': MEDIA_URL+'js/jquery-1.11.0.min.js',
